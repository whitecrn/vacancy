...
program vacancy
        ...
        integer :: seed_size
        write(*,*) 'Which element do you want to opearte?'
        read(*,*) op
        ...
        if (alive) then
                ...
                do i=1,v
                        ...
                        !r(i) = abs(sin(real(i)+1))
                end do

                do i = 1,v
                        if (op == 1) then
                                r(i) = 1+int(floor(r(i)*n_li))
                        else if (op == 2) then
                                r(i) = n_li+1+int(floor(r(i)*n_la))
                        else if (op == 3) then
                                r(i) = n_li+n_la+1+int(floor(r(i)*n_zr))
                        else if (op == 4) then
                                r(i) =n_li+n_la+n_zr+1+int(floor(r(i)*n_o))
                        end if
                end do
